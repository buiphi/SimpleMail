...
//		String senderPrivateKeyFile, keyPassword, senderPublicKeyFile;
//					
//		//Enter password for extracting private key
//		senderPrivateKeyFile = "phiprv.pem";
//		senderPublicKeyFile = "phipub.pem";
//		keyPassword = "12345";
//		try {
...
//					
//			String message = "mDt6ePH1BXi6OVubMxvpeYvEnsgve9DdG0kb+orBKzw=";
//			String message2 = "mDt6ePH1BXi6OVubMxvpeYvEnsgve9DdG0kb+orBKzw=";
//			String signature = signOperator.signString(senderPrivateKey, message);
//			
//			if(verifyOperator.verifyString(senderPublicKey, message2, signature))
